...
export const policies = {
  privacy: {
    ...
    bannerText:
      'How Gujju Express collects, uses, and protects your personal information.',
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          `If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at ${CONTACT.email} or mailing us at: ${CONTACT.address}.`,
        ],
      },
      {
      ...
      {
        title: 'SECTION 10 - QUESTIONS AND CONTACT INFORMATION',
        items: [
          `If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at ${CONTACT.email} or by mail at ${CONTACT.address}.`,
        ],
      },
    ],
  },
  terms: {
    ...
    bannerText:
      'Terms of Service governing your use of the Gujju Express website and services.',
    sections: [
      {
        title: 'OVERVIEW',
        items: [
          'This website is operated by Gujju Express. Throughout the site, the terms “we”, “us” and “our” refer to Gujju Express. Gujju Express offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.',
      ...
      },
      {
        ...
        items: [
          ...
          'In no case shall Gujju Express, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.',
        ],
      },
      {
        title: 'SECTION 14 - INDEMNIFICATION',
        items: [
          'You agree to indemnify, defend and hold harmless Gujju Express and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.',
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          `Questions about the Terms of Service should be sent to us at ${CONTACT.email} or by mail at ${CONTACT.address}.`,
        ],
      },
    ],
  },
  refund: {
    title: 'Refund Policy',
    bannerText:
      'Information about refunds for Gujju Express services.',
    sections: [
      {
        title: 'Refund Policy',
        items: [
  ...
  shipping: {
    ...
    bannerText:
      'Delivery timelines and shipping information for domestic and international courier services.',
    sections: [
      {
        title: 'Shipping Policy',
        items: [
